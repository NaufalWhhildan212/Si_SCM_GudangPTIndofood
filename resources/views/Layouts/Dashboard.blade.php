          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              ...
              <li class="nav-item"> <a class="nav-link" href="Pegawai">Data Pegawai</a></li>
                <li class="nav-item"> <a class="nav-link" href="Supir">Data Supir</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="form-elements">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="Gudang">Data Gudang</a></li>
                ...
                <li class="nav-item"><a class="nav-link" href="Stok">Data Stok barang</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="charts">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="Pengiriman">Data Pengiriman</a></li>
                <li class="nav-item"> <a class="nav-link" href="Jadwal">Data Jadwal</a></li>
                <li class="nav-item"> <a class="nav-link" href="Rute">Data Rute</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="tables">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="Truk">Data Truk</a></li>
              </ul>
            </div>
          </li>
        </ul>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        ...
                        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center text-muted">Desain By Muhammad Naufal Whildan Sutoko</span>
                    </div>
                </div>    
            </div>        
        </footer>
